          ...
          {plan?.opportunities.map((opp) => (
            ...
            >
              ...
              <div className="mt-3 flex flex-wrap items-center gap-2">
                {opp.executable && opp.fromChain && opp.toChain ? (
                  <button
                    type="button"
                    onClick={() => {
                      onPrefillBridge?.(opp.fromChain!, opp.toChain!);
                      document.getElementById("cctp-execute")?.scrollIntoView({
                        behavior: "smooth",
                      });
                    }}
